-- Phase 1: Population des données de base pour le module Resources
...
INSERT INTO public.rooms (name, code, room_type, capacity, status, building, floor) VALUES
('Amphi A1', 'AA1', 'amphitheater', 200, 'available', 'Bâtiment A', 1),
('Salle B2', 'SB2', 'classroom', 30, 'available', 'Bâtiment B', 2),
('Lab Info C3', 'LC3', 'laboratory', 25, 'available', 'Bâtiment C', 3),
('Administration', 'ADM', 'office', 10, 'available', 'Bâtiment Admin', 1),
('Bibliothèque', 'BIB', 'library', 50, 'available', 'Bâtiment Central', 2)
ON CONFLICT (code) DO NOTHING;
