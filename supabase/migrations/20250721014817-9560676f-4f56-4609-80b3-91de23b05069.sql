...
-- 4. Corriger les statuts des années académiques avec les bonnes valeurs
-- Marquer toutes les années comme non-courantes d'abord
UPDATE public.academic_years SET is_current = false;

-- Marquer l'année 2024-2025 comme courante (status 'active')
UPDATE public.academic_years 
...
-- 5. Créer l'année académique 2025-2026 si elle n'existe pas déjà
