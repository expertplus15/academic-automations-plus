...
ALTER TABLE public.document_variables ADD CONSTRAINT IF NOT EXISTS document_variables_name_unique UNIQUE (name);
ALTER TABLE public.document_templates ADD CONSTRAINT IF NOT EXISTS document_templates_code_unique UNIQUE (code);
