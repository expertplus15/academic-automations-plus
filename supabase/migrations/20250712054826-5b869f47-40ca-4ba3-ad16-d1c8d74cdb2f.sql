-- Script de données test pour diagnostic Finance - Version corrigée
...
-- 2. Ajouter des comptes du plan comptable (types français)
...
SELECT 
  ...
  CASE 
    WHEN ae.description LIKE '%Achat fournitures bureau%' THEN 
      CASE WHEN ca.account_number = '606100' THEN 'Fournitures bureau'
           ...
           WHEN ca.account_number = '401001' THEN 'Fournisseur Bureau Expert'
      END
    WHEN ae.description LIKE '%Dupont%' THEN
    ...
    WHEN ae.description LIKE '%salaires%' THEN
      ...
      END
    WHEN ae.description LIKE '%Martin%' THEN
      CASE WHEN ca.account_number = '512100' THEN 'Encaissement banque'
           WHEN ca.account_number = '707000' THEN 'Prestation formation'
      END
    WHEN ae.description LIKE '%maintenance%' THEN
      CASE WHEN ca.account_number = '606200' THEN 'Maintenance informatique'
           WHEN ca.account_number = '512100' THEN 'Paiement banque'
      END
    WHEN ae.description LIKE '%Durand%' THEN
      CASE WHEN ca.account_number = '512100' THEN 'Frais inscription'
           WHEN ca.account_number = '707000' THEN 'Services inscription'
      END
    WHEN ae.description LIKE '%fournitures pédagogiques%' THEN
      CASE WHEN ca.account_number = '606100' THEN 'Fournitures pédagogiques'
           WHEN ca.account_number = '512100' THEN 'Paiement banque'
      END
  END,
  CASE 
    ...
    -- Paiements étudiants (encaissements)
    ...
    WHEN ae.description LIKE '%Durand%' AND ca.account_number = '512100' THEN 450.00
    
    -- Achats (débits charges)
    WHEN ae.description LIKE '%matériel informatique%' AND ca.account_number = '606200' THEN 850.00
    WHEN ae.description LIKE '%maintenance%' AND ca.account_number = '606200' THEN 1500.00
    WHEN ae.description LIKE '%fournitures pédagogiques%' AND ca.account_number = '606100' THEN 680.00
  ...
  CASE 
    ...
    -- Encaissements étudiants - Crédit prestations
    ...
    WHEN ae.description LIKE '%Durand%' AND ca.account_number = '707000' THEN 450.00
    
    -- Paiements - Crédit banque
    WHEN ae.description LIKE '%matériel informatique%' AND ca.account_number = '512100' THEN 850.00
    WHEN ae.description LIKE '%maintenance%' AND ca.account_number = '512100' THEN 1500.00
    WHEN ae.description LIKE '%fournitures pédagogiques%' AND ca.account_number = '512100' THEN 680.00
...
WHERE 
  ...
  OR (ae.description LIKE '%Durand%' AND ca.account_number IN ('512100', '707000'))
  OR (ae.description LIKE '%matériel informatique%' AND ca.account_number IN ('606200', '512100'))
  OR (ae.description LIKE '%maintenance%' AND ca.account_number IN ('606200', '512100'))
  OR (ae.description LIKE '%fournitures pédagogiques%' AND ca.account_number IN ('606100', '512100'))
