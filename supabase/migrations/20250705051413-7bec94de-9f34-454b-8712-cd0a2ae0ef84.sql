-- Phase 1: Population des données de base pour le module Resources (corrigée)
...
('Lab Info C3', 'LC3', 'laboratory', 25, 'available', 'Bâtiment C'),
('Administration', 'ADM', 'office', 10, 'available', 'Bâtiment Admin'),
('Bibliothèque', 'BIB', 'library', 50, 'available', 'Bâtiment Central')
ON CONFLICT (code) DO NOTHING;
