-- PHASE 1: Création complète de la structure DUTGE
...
-- PHASE 2: Créer les niveaux académiques spécifiques (avec education_cycle = 'short' pour DUT)
...
('DUT1-GE', 'DUT1GE', 'short', 1, 1, 2, 60, now(), now()),
('DUT2-GE', 'DUT2GE', 'short', 2, 1, 2, 60, now(), now())
ON CONFLICT (code) DO UPDATE SET
  name = EXCLUDED.name,
...
-- PHASE 3: Créer les classes et groupes
...
-- PHASE 4: Créer toutes les matières SEMESTRE 3 et 4
...
-- PHASE 5: Configuration du système de notation
