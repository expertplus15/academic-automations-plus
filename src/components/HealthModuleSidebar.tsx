...
const healthSubModules = [
  {
    ...
    url: "/health/records",
    icon: FileText,
    description: "Sécurisés RGPD - confidentiels"
  },
  {
    title: "Planning consultations",
    url: "/health/appointments",
    icon: Calendar,
    description: "Rendez-vous infirmerie"
  },
  {
  ...
  },
  {
    ...
    icon: AlertTriangle,
    description: "Procédures et contacts"
  },
  {
    title: "Aménagements handicap",
    url: "/health/accessibility",
    icon: Accessibility,
    description: "PAI et adaptations"
  },
];
    ...
    <Sidebar className="border-r border-border/50">
      <SidebarHeader className="border-b border-border/50 p-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-health rounded-lg flex items-center justify-center">
            <Heart className="w-4 h-4 text-white" />
          </div>
          <div>
            <h1 className="text-lg font-bold text-foreground">Santé</h1>
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {healthSubModules.map((subModule) => {
                    ...
                    <SidebarMenuButton asChild>
                      ...
                      >
                        <div 
                          ...
                          style={{ backgroundColor: "rgb(var(--health))" }}
                        >
