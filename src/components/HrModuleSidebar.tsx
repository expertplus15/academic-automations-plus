    ...
    <Sidebar className="border-r-0">
      ...
      <SidebarContent className="px-4">
        <div className="pt-4 pb-2">
          <Link to="/hr" className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-sidebar-accent transition-colors w-full">
        ...
        <SidebarGroup className="py-4">
          <SidebarGroupContent>
            <Accordion type="multiple" defaultValue={["gestion-personnel"]} className="w-full space-y-2">
