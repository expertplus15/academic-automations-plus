      ...
      <header className="h-16 bg-card border-b border-border flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Gestion Intelligente des Examens</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80 bg-background border border-border">
              <DropdownMenuLabel>Notifications examens</DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuItem className="p-3 hover:bg-muted transition-colors">
                <div className="flex flex-col gap-1">
                  <p className="text-sm font-medium">12 examens à planifier</p>
