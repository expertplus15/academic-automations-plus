...
const resourcesSubModules = [
  ...
  },
  {
    ...
    icon: Wrench,
    description: "Automatisée - planifiée"
  },
  {
  ...
  },
  {
    ...
    icon: Building,
    description: "Suivi et valorisation"
  },
];
    ...
    <Sidebar className="border-r border-border/50">
      <SidebarHeader className="border-b border-border/50 p-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-resources rounded-lg flex items-center justify-center">
            <Package className="w-4 h-4 text-white" />
          </div>
          <div>
            <h1 className="text-lg font-bold text-foreground">Ressources</h1>
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {resourcesSubModules.map((subModule) => {
                    ...
                    <SidebarMenuButton asChild>
                      ...
                      >
                        <div 
                          ...
                          style={{ backgroundColor: "rgb(var(--resources))" }}
                        >
