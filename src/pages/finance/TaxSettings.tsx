...
export default function TaxSettings() {
  ...
  const stats = [
    {
      label: "Taux configurés",
      value: taxRates.filter(t => t.isActive).length.toString(),
      change: "+1",
    ...
    <ModuleLayout sidebar={<FinanceModuleSidebar />}>
      <div className="p-8 space-y-8">
        <FinancePageHeader
          ...
          subtitle="Configuration des taux de taxes et TVA"
          stats={stats}
        ...
        <Card className="bg-white rounded-2xl shadow-sm border-0">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Settings className="w-5 h-5 text-[rgb(245,158,11)]" />
              Configuration générale
            </CardTitle>
          </CardHeader>
        ...
        <Card className="bg-white rounded-2xl shadow-sm border-0">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button className="bg-[rgb(245,158,11)] hover:bg-[rgb(245,158,11)]/90">
              Ajouter un taux
            </Button>
          </CardHeader>
          <CardContent>
        ...
        <div className="flex gap-4">
          <Button className="bg-[rgb(245,158,11)] hover:bg-[rgb(245,158,11)]/90 gap-2">
